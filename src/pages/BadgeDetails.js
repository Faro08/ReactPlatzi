...
function BadgeDetails (props){
    ...
    /* const [ count, setCount] = React.useState(0) // [state, setState], el estado es el argumento de useState */
            ...
            <div className="col">
                ...
                <div>
                    <div>
                        ...
                        <Link className="btn btn-primary mb-4" to={`/badges/${badge.id}`}>Editar</Link>
                    </div>
                </div>
                <div>
